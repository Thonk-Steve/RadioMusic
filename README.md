...
A digital way to simulate the radio-powered compositions of John Cage and Karlheinz Stockhausen as well as Don Buchla's voltage-controlled radio experiments. It uses a [Teensy 3.1/3.2](https://www.thonk.co.uk/shop/teensy-3-2/) to play files from an SD card to simulate a voltage controlled AM/FM/Shortwave/Time Travel radio. We recommend using a genuine Teensy from Thonk OR directly from PJRC only or you may have some compatibility issues.
